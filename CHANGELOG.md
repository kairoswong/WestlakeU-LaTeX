...
- Added `\wl@once` utility macro for once-only command protection
- Added reusable `\wl@package@conflict` macro with expanded conflict detection
...
- Updated path references, build scripts, and README accordingly
 - Removed `cover` build target alias
